...
- In the Northwind database, what is the type of relationship between the
  ...
  **Since each employee can have multiple territories, it is a one-to-many relationship**
- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
  **Database choice should be based on schema. It is quicker to use MongoDB for rapid prototyping, and when you're dealing with a huge dataset, since relational databases don't scale well and queries would take a long time.  MongoDB would be the right choice in circumstances where you're looking for simplicty of storing data and scalability, and where we'd be looking to insert data into the database with ease.  Contrast this to relational databases where it is hard to insert data due to the setup of the database and restrictive rules, but it is much easier to query.  Last consideration: team experience; if a team is more experienced with a relational database, and not with NoSQL databases, it might be the right decision to stick with a relational database**
- What is "NewSQL", and what is it trying to achieve?
**NewSQL is a new type of relational database management system that aims to provide the same scalable performance of NoSQL systems for online transaction processing (OLTP) read-write workloads while still maintaining the ACID guarantees of a traditional database system.**
### Part 5 - Turn it in!
